...
import { getCuenta } from '@/lib/cuentas'
import BienvenidaForm from './BienvenidaForm'
import PruebaActivaRedirect from './PruebaActivaRedirect'
...
export default async function BienvenidaPage() {
  ...
  // Si la cuenta ya existe (prueba recién activada), no mostramos el formulario:
  // esperamos a que el token de sesión refleje el estado y entramos al CRM.
  const cuenta = await getCuenta(userId)
