...
> Registrar el peso siempre en las mismas condiciones (idealmente en ayunas,
> a la mañana, antes de comer) para que los datos sean comparables.

## Fase 1 — Semanas 1 a 12 (objetivo: 110 kg → ~98-100 kg)

| Semana | Fecha | Peso (kg) | Cintura (cm, opcional) | ¿Cumplí el plan de ejercicio? | Notas |
|---|---|---|---|---|---|
| 0 (inicio) | 30/06/2026 | 110 | | | Punto de partida |
| 1 | | | | | |
| 2 | | | | | |
| 3 | | | | | |
| 4 | | | | | |
...
- Peso alcanzado: _____ kg
- ¿Se cumplió el ritmo esperado (~10-12 kg)? Sí / No
- ¿Cómo fue la adherencia al plan de ejercicio (fuerza + running)?
- ¿Cómo fue la energía/recuperación durante los entrenamientos?
- ¿Hubo molestias físicas (articulares, fatiga)?
- ¿Ya se siente cómodo trotando 25-30 min seguidos / jugando al fútbol
  recreativo?
- Ajustes propuestos para la Fase 2 (ritmo de pérdida, volumen de
  entrenamiento, déficit calórico):

## Fase 2 — Seguimiento mensual (objetivo: ~98-100 kg → 85 kg)

| Mes | Fecha | Peso (kg) | Notas |
|---|---|---|---|
| 1 | | | |
| 2 | | | |
| 3 | | | |
